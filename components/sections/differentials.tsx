    ...
    <section id="diferenciais" className="py-20 lg:py-28 bg-slate-900 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto mb-14">
          <div className="text-[var(--color-secondary,#10B981)] text-sm font-bold uppercase tracking-wider mb-3">{title}</div>
          ...
          <div className="grid sm:grid-cols-2 gap-6">
            {items.map((item) => {
              ...
              return (
                ...
                >
                  <div className="w-10 h-10 rounded-lg bg-[var(--color-primary,#1E88E5)]/20 text-[var(--color-primary,#1E88E5)] flex items-center justify-center mb-4"
                  >
        ...
        <div className="grid md:grid-cols-2 gap-6">
          {testimonials.map((t) => (
            ...
            >
              <Quote className="w-8 h-8 text-[var(--color-primary,#1E88E5)] mb-4" />
