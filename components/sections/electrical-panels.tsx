...
interface ElectricalPanelsProps {
  title: string;
  headline: string;
  description: string;
  image: string;
...
export function ElectricalPanelsSection({
  title,
  headline,
  description,
  image,
  imageAlt,
  items,
}: ElectricalPanelsProps) {
  return (
    <section id="quadros-eletricos" className="py-20 lg:py-28 bg-white">
