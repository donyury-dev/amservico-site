          ...
          {items.map((service) => {
            ...
            return (
              <Link
                key={service.id}
                href={service.href}
                className="group p-6 rounded-xl border border-slate-100 bg-slate-50 hover:bg-white hover:shadow-xl hover:border-[var(--color-primary)]/20 transition-all"
              >
                <div className="w-12 h-12 rounded-lg bg-[var(--color-primary)]/10 text-[var(--color-primary)] flex items-center justify-center mb-4 group-hover:bg-[var(--color-primary)] group-hover:text-white transition-colors"
                >
